                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{route('customer.update')}}" id="myForm">
                                @csrf
                                <input type="hidden" name="id" value="{{$customer->jeha_no}}">

                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">اسم الزبون</label>
                                    <div class="col-sm-10 form-group">
                                        <input name="jeha_name" class="form-control" type="text"  value="{{$customer->jeha_name}}" >
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 form-group">
                                        <input name="libyana" class="form-control" type="text" value="{{$customer->libyana}}" >
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 form-group">
                                        <input name="mdar" class="form-control" type="text" value="{{$customer->mdar}}" >
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 form-group">
                                        <input name="others" class="form-control" type="text" value="{{$customer->others}}" >
                                    </div>
                                </div>
                                <!-- end row -->
