<div class="vertical-menu"  >
    ...
    <div data-simplebar  >
        ...
        <div id="sidebar-menu">
            <!-- Left Menu Start -->
            <ul class="etatisme list-styled" id="side-menu" >
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">تقارير عن المصارف</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{route('pagi-rep_bank',0)}}">تقرير حسب المصرف</a></li>
                                <li><a href="{{route('rep_banks.sum')}}">تقرير بإجمالي المصارف</a></li>
                ...
                <li class="menu-title">فوانير</li>

                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="ri-account-circle-line"></i>
                        <span>فواتير مشتريات</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('order_buy.add')}}">ادخال فاتورة مشتريات</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('customer.all')}}">تقرير عن الزبائن</a></li>
